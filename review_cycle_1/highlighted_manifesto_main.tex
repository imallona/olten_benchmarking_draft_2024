...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{review_cycle_1/figures/fig_benchmarking_aligned.pdf}
...
\begin{figure}
    ...
    \includegraphics[width=0.75\linewidth]{figures/bens_formalization_arrows.pdf} % alternative
