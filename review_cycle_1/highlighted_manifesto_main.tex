...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{review_cycle_1/figures/fig1_fig_benchmarking_aligned.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{../original_submission/figures/fig2_bens_layers.pdf}
