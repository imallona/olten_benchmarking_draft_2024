...
Benchmarking systems are software meant to orchestrate other software (e.g. benchmarked methods). Software are run on specific hardware, from commodity computers to dedicated hardware, often large servers or academic and commercial clouds, posing a challenge: benchmarked methods should have access to comparable resources (hardware).

compilation flags

multiarch, ARMs

containers, discuss software then

computing quotas, concurrency, IO

how to profile performance and fingerprint resources
}
